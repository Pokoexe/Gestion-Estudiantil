    ...
    nav: [
      {
        items: [
          ...
          { icon: UserCog, label: "Usuarios y roles", to: "usuarios", ready: true },
          { icon: Activity, label: "Estado del sistema", to: "estado", ready: true },
          { icon: ScrollText, label: "Registros", to: "registros", ready: true },
          { icon: Plug, label: "Integraciones", to: "integraciones", ready: true },
        ],
      },
      { items: [{ icon: Settings, label: "Configuración", to: "configuracion", ready: true }] },
    ],
