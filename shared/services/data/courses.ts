...
export const EXTRA_COURSES: ExtraCourse[] = [
    ...
    },
    {
        ...
        enrolledCount: 14,
        description:
            "Practica el inglés en situaciones reales mediante juegos de rol, conversaciones guiadas y actividades dinámicas en grupo.",
        image: "https://picsum.photos/seed/ingles/640/360",
        code: "EXT-ING",
        schedule: "Mar / Jue · 16:00 – 17:00",
        room: "Aula 210",
        term: "2026-I",
        evaluations: [
            { id: 1, title: "Diálogo en parejas", type: "presentation", dueDate: "23 jul 2026", weight: "40%", status: "pending" },
            { id: 2, title: "Examen oral", type: "exam", dueDate: "13 ago 2026", weight: "60%", status: "pending" },
        ],
    },
    {
        id: 12,
        title: "Danza contemporánea",
        teacher: "Prof. Valentina Ruiz",
        date: "9 jul 2026",
        topic: "arte",
        price: 16,
        totalSpots: 20,
        enrolledCount: 11,
        description:
            "Explora el movimiento y la expresión corporal a través de la danza contemporánea, combinando técnica, ritmo y creatividad.",
        image: "https://picsum.photos/seed/danza/640/360",
        code: "EXT-DAN",
        schedule: "Lun / Mié · 15:00 – 16:30",
        room: "Sala de danza",
        term: "2026-I",
        enrollment: "active",
        evaluations: [
            { id: 1, title: "Rutina individual", type: "presentation", dueDate: "25 jul 2026", weight: "50%", status: "pending" },
            { id: 2, title: "Coreografía grupal", type: "presentation", dueDate: "15 ago 2026", weight: "50%", status: "pending" },
        ],
    },
    {
        id: 13,
        title: "Pintura y dibujo artístico",
        teacher: "Prof. Hugo Medina",
        date: "10 jul 2026",
        topic: "arte",
        price: 18,
        totalSpots: 18,
        enrolledCount: 9,
        description:
            "Desarrolla tu creatividad aprendiendo técnicas de dibujo, color y composición para crear tus propias obras artísticas.",
        image: "https://picsum.photos/seed/pintura/640/360",
        code: "EXT-PIN",
        schedule: "Sáb · 10:00 – 12:00",
        room: "Taller de arte",
        term: "2026-I",
        evaluations: [
            { id: 1, title: "Estudio de bocetos", type: "lab", dueDate: "24 jul 2026", weight: "40%", status: "pending" },
            { id: 2, title: "Obra final", type: "presentation", dueDate: "21 ago 2026", weight: "60%", status: "pending" },
        ],
    },
    {
        id: 14,
        title: "Astronomía para jóvenes",
        ...
        enrolledCount: 13,
        description:
            "Descubre el universo, los planetas y las estrellas con observaciones guiadas y proyectos sobre el sistema solar.",
        image: "https://picsum.photos/seed/astronomia/640/360",
        code: "EXT-AST",
        schedule: "Vie · 16:00 – 17:30",
        room: "Planetario escolar",
        term: "2026-I",
        evaluations: [
            { id: 1, title: "Mapa estelar", type: "lab", dueDate: "26 jul 2026", weight: "45%", status: "pending" },
            { id: 2, title: "Proyecto del sistema solar", type: "presentation", dueDate: "18 ago 2026", weight: "55%", status: "pending" },
        ],
    },
];
