...
import type { Planificacion, PlanifSesion } from "@shared/services/data/planificaciones";

export type { Planificacion, PlanifSesion, PlanifEstado } from "@shared/services/data/planificaciones";
