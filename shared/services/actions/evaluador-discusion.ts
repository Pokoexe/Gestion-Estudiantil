...
import type { StudentRow } from "@shared/services/data/evaluador-discusion";

export type { StudentRow, Materia, MatStatus } from "@shared/services/data/evaluador-discusion";
