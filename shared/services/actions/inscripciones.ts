...
import type { Inscripcion } from "@shared/services/data/inscripciones";

export type { Inscripcion, InscripcionEstado, InscripcionTipo } from "@shared/services/data/inscripciones";
