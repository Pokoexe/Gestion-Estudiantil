      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="col-span-2 bg-edu-surface rounded-edu-card border border-edu-border-soft overflow-hidden">
          <div className="px-5 py-4 border-b border-edu-border-soft flex justify-between items-center">
            ...
            <button
              className={`inline-flex items-center gap-2 px-[18px] py-2.5 rounded-edu-control text-sm font-semibold cursor-pointer transition-colors "border-[1.5px] border-edu-primary bg-edu-primary text-white hover:bg-edu-primary-hover"
              `}
            >
                  ...
                  <div className="flex flex-col gap-1.5">
                    {classes.map((cls, i) => (
                      ...
                      >
                        ...
                        <div className="text-[0.8rem] text-edu-ink font-semibold mt-px">
                          {cls.subject}
                        </div>
