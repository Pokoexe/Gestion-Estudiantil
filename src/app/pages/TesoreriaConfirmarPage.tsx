    ...
    <div className="flex flex-col gap-5">
      ...
      {pending.length === 0 ? (
        ...
        <div className="grid grid-cols-2 gap-4">
          {pending.map((p) => (
            <div key={p.id} className="bg-edu-surface rounded-edu-card border border-edu-border-soft overflow-hidden flex flex-col">
              <div className="flex gap-3.5 p-4">
                {/* Miniatura de comprobante */}
                <div className="w-20 h-20 rounded-edu-control bg-edu-subtle border border-edu-border-soft flex flex-col items-center justify-center gap-1 shrink-0">
