...
import type { accent as accentTokens } from "@themes/tokens";

type AccentToken = (typeof accentTokens)[keyof typeof accentTokens];
...
interface PreciosKpiRowProps {
    KPIS: KpiItem[];
}

export function PreciosKpiRow({ KPIS }: PreciosKpiRowProps) {
    return (
