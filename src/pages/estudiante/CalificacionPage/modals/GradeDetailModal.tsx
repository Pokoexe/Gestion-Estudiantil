...
import { TYPE_META } from "../ui/typeMeta";
...
/** Modal con el detalle de una evaluación calificada. */
export function GradeDetailModal({ selected, onClose }: GradeDetailModalProps) {
    return (
        <div
