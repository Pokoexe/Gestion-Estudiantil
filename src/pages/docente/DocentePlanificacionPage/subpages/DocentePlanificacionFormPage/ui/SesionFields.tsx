...
interface SesionFieldsProps {
    rows: PlanifSesion[];
    activeTab: number;
    updateRow: (rid: number, field: keyof PlanifSesion, value: string) => void;
    removeRow: (index: number) => void;
    addFiles: (rid: number, files: FileList) => void;
    removeFile: (rid: number, idx: number) => void;
}

export function SesionFields({
    rows,
    activeTab,
    updateRow,
    removeRow,
    ...
    if (typeof activeTab !== "number" || !rows[activeTab]) return null;
