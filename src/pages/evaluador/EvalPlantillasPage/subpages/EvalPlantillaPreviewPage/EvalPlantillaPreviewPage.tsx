...
import { useEvalPlantillaPreview, TEAL, TEAL_50 } from "./functions/useEvalPlantillaPreview";
import { CampoPreview } from "./ui/CampoPreview";

export function EvalPlantillaPreviewPage() {
  const { navigate, campos } = useEvalPlantillaPreview();
